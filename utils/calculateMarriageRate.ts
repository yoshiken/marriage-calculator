...
function calculateEducationScore(age:number, gender:string, education: string, score:number): number {
  const educationScores: { [key: string]: { [key: string]: number[] } } = {
    male: {
      "義務": [0.0, 0.0, 39.1, 88.8, 31.3, 18.6, 18.2, 53.9, 54.1],
      "高校": [46.0, 75.8, 84.9, 72.4, 59.6, 57.3, 31.9, 148.9, 141.1],
      "専門": [0.0, 107.4, 90.6, 72.6, 58.0, 62.0, 33.5, 253.0, 364.9],
      "高専": [0.0, 140.7, 88.8, 72.2, 43.4, 66.2, 78.2, 312.7, 373.2],
      "短大": [0.0, 26.1, 78.2, 70.6, 55.8, 22.7, 175.9, 171.6, 74.1],
      "大学": [106.6, 113.9, 117.6, 97.2, 74.5, 68.3, 209.5, 236.3, 99.6],
      "大学院": [169.5, 148.5, 122.1, 104.9, 105.3, 52.2, 400.3, 540.6, 136.9],
      "その他": [0.0, 60.1, 73.3, 93.1, 88.8, 27.9, 167.5, 97.7, 87.7]
    },
    female: {
      "義務": [0.0, 0.0, 325.7, 76.0, 114.0, 101.3, 0.0, 0.0, 26.8],
      "高校": [171.0, 183.3, 162.8, 106.3, 108.4, 72.3, 65.1, 66.0, 39.9],
      "専門": [188.7, 162.3, 164.0, 108.5, 100.0, 68.1, 69.7, 70.8, 61.8],
      "高専": [0.0, 47.2, 84.0, 87.7, 51.8, 87.7, 182.4, 57.0, 0.0],
      "短大": [0.0, 174.2, 121.2, 73.4, 73.9, 44.9, 54.1, 37.6, 82.4],
      "大学": [139.3, 158.8, 131.2, 91.5, 71.3, 58.0, 41.6, 47.9, 100.4],
      "大学院": [154.2, 130.9, 99.5, 87.3, 73.5, 74.0, 127.7, 19.0, 105.4],
      "その他": [0.0, 182.4, 97.7, 114.0, 50.7, 76.0, 0.0, 91.2, 82.9]
    }
  };

  const resultList = educationScores[gender][education] || [];
