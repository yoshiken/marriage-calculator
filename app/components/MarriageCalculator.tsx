    ...
    <div className="p-4">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select name="livingTogetherMyFamily" value={inputs.livingTogetherMyFamily} onChange={handleChange} className={styles.select}>
        ...
        <div>
          ...
          <select name="livingTogetherPartnerFamily" value={inputs.livingTogetherPartnerFamily} onChange={handleChange} className={styles.select}>
